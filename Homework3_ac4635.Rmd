...
On the right panel, we observe a distribution of snowfall values between 0 and 100 degrees Celsius. We observe the two highest peaks from the snowfall plot under 25mm every year. There is no substantial difference of snowfall values across the years. 
